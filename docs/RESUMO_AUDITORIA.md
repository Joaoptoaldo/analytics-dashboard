...
|---|----------|-----------|---------|--------|
| 1 | Dados sintéticos visíveis | 🔴 Crítica | is_synthetic flag + global filter | OK |
| 2 | Top Products placeholders | 🟠 Alto | Filtro no serviço | OK |
| 3 | Categorias placeholder | 🟠 Alto | Filtro no serviço | OK |
| 4 | Label granularidade | 🟡 Médio | Dynamic label | OK |
| 5 | get_sales_monthly sem filtro | 🟠 Alto | Adicionado filtro | OK |
...
5. **Considerar** hash de dados para auditoria adicional
